...
const int 
   n_productoras = 3,   // Deben ser divisores del número de ítems a producir consumir (15)
   n_consumidoras = 3;
...
class ProdConsMu : public HoareMonitor
{
 ...
 int                        // variables permanentes
   ...
   primera_ocupada;
   int cont;   // Indica el número de celcas ocupadas del buffer
...
void funcion_hebra_productora( MRef<ProdConsMu> monitor, int x )
{
...
int main()
{
   ...
   thread
      hebra_prod[n_productoras],
      hebra_cons[n_consumidoras];
